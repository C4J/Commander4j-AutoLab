...
public class JDialogOrderInfo extends JDialog
{
	...
	public JDialogOrderInfo(String uuid)
	{
		...
		okClose.setBounds(284, 360, 106, 29);
		...
		JLabel lblExpiryDate = new JLabel(JRes.getText("shelf_life")+" :");
		...
		JLabel lblCustomerID = new JLabel(JRes.getText("customer_id")+" :");
		...
		JLabel lblShelfLifeUom = new JLabel(JRes.getText("shelf_life_unit")+" :");
		...
		JLabel lblShelfLifeRule = new JLabel(JRes.getText("shelf_life_rule")+" :");
		...
		JLabel lblVariant = new JLabel(JRes.getText("variant")+" :");
		lblVariant.setHorizontalAlignment(SwingConstants.RIGHT);
		lblVariant.setBounds(14, 322, 144, 26);
		contentPanel.add(lblVariant);
		
		JButton okRefresh = new JButton(JRes.getText("refresh"));
		okRefresh.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				refresh();
			}
		});
		okRefresh.setActionCommand("OK");
		okRefresh.setBounds(186, 360, 106, 29);
		contentPanel.add(okRefresh);
	...
	public void refresh()
	{
		...
		jTextFieldProductionUOM.setText(AutoLab.getDataSet_Field(getUuid(), "UOM"));
